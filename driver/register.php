...
else if(isset($_POST['submit_N']) || isset($_POST['submit_L']))
{
	...
	else if(strlen(trim($_POST['carPlateNum'])) == 0)
	{
	...
	else
	{
		...
		if($stmt = $pdo->prepare($sql))
		{
	        ...
	        else
	        {
				    ...
				    $sql = "INSERT INTO drivers (username, carClass, carModel, carPlateNum) VALUES (:username, :carClass, :carModel, :carPlateNum, :profileImg)";
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button onclick="location.href='Welcome.php';" class="btn btn-primary" data-dismiss="modal" >OK</button>
				</div>
			</div>
		</div>
	</div>
